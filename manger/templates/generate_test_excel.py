...
headers = ['题目类型', '题目内容', '选项A', '选项B', '选项C', '选项D', '选项E', '正确答案', '难度', '分值', '知识点', '标签', '答案解析', '编程语言', '图片路径']
ws.append(headers)

column_widths = [12, 50, 20, 20, 20, 20, 20, 12, 10, 8, 15, 15, 30, 12, 15]
...
print('共包含 25 道测试题目（包含22道常规题目和3道程序题）')
